...
public class RealViewSwitcher extends ViewGroup {
	...
	private boolean sistemaMovimientoActivado;

	public boolean isSistemaMovimientoActivado() {
		return sistemaMovimientoActivado;
	}

	public void setSistemaMovimientoActivado(boolean sistemaMovimientoActivado) {
		this.sistemaMovimientoActivado = sistemaMovimientoActivado;
	}
